...
• Duplicated lines in the validation split: 2 lines or 0.242%.<br> 
• Duplicated lines in the test split: 2 lines or 0.233%.<br>
Thus, between leaks and duplications, the performance measured on the test split is biased by at least 1.750%.<br>
...
Thus, between leaks and duplications, the performance measured on the test split is biased by at least 0.831%.<br>
...
-	Wikiann :<br>
• Leakage between training and test splits: 742 lines or 3.71%.<br>
• Leakage between validation split and test split: 473 lines or 4.73%.<br>
• Duplicated lines in the training split: 1,889 lines or 9.445%.<br>
• Duplicated lines in the validation split: 644 lines or 6.44%.<br>
• Duplicated lines in the test split: 644 lines or 6.44%.<br>
