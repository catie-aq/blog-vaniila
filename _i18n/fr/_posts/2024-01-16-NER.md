...
-	<a href="http://dx.doi.org/10.1016/j.artint.2012.03.006">WikiNER</a> de Nothman et al. (2013) qui est un jeu de données de 120 682 données d’entraînement et 13 410 de test. Les entités annoncées sont LOC (Localisation), ORG (Organisations), PER (Personnes) et MISC (Divers) et sont réparties de la façon suivante :<br>
<table class="center">
<thead>
<tr>
<th>Split</th>
