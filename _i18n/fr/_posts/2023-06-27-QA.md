...
Pour <a href="https://huggingface.co/spaces/evaluate-metric/squad_v2">SQuAD 2.0</a>, en plus de calculer l’<i>exact-match</i>i> et le score F1, il est possible d’obtenir le détail du F1 et de l’<i>exact-match</i>i> pour les questions possédant une réponse de même que le détail du F1 et de l’<i>exact-match</i>i> pour les questions ne possédant pas de réponse.
</p>
