...
Nous nous retrouvons ainsi avec un jeu de données augmenté dont la réponse peut ou non e^tre présente dans le contexte, pour un total de de 227 726 (221 350 pour l’entraînement, 6 376 pour le test) triplets questions/réponses/contextes. <br>
