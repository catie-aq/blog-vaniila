...
Pour <a href="https://huggingface.co/spaces/evaluate-metric/squad), ">SQuAD 1.0</a>, l’<i>exact-match</i>i> et le score F1 sont calculés. L’<i>exact match</i>i> est basé sur la correspondance stricte des caractères de la réponse prédite et de la bonne réponse. Pour les réponses correctement prédites, la correspondance exacte sera de 1. Et même si un seul caractère est différent, la correspondance exacte sera de 0. <br>
